...
<!DOCTYPE html> <html lang="en"> <head> <meta charset="UTF-8" /> <meta name="viewport" content="width=device-width, initial-scale=1" /> <title>KSmart - Dresses</title> <style> body { margin: 0; font-family: 'Segoe UI', sans-serif; background-color: #f8f9fa; color: #333; }
header {
...
<div class="card">
  <img src="download (4).jpeg" alt="Dresses 1" />
  <div class="card-body">
    <h3>ROYALICA</h3>
    <div class="price-buy">
      <p>₹1099</p>
...
<div class="card">
  <img src="images (9).jpeg" alt="Dresses 2" />
  <div class="card-body">
    <h3>GRECIILOOKS</h3>
    <div class="price-buy">
      <p>₹599</p>
...
<div class="card">
  <img src="download (5).jpeg" alt="Dresses 3" />
  <div class="card-body">
    <h3>Van Heusen</h3>
    <div class="price-buy">
      <p>₹749</p>
...
<div class="card">
  <img src="images (10).jpeg" alt="Dresses 4" />
  <div class="card-body">
    <h3>PURVAJA</h3>
    <div class="price-buy">
      <p>₹549</p>
...
<div class="card">
  <img src="images (31).jpeg" alt="Dresses 5" />
  <div class="card-body">
    <h3>AASK </h3>
    <div class="price-buy">
      <p>₹799</p>
...
<div class="card">
  <img src="images (30).jpeg" alt="Dresses 6" />
  <div class="card-body">
    <h3>Aahwan</h3>
    <div class="price-buy">
      <p>₹999</p>
